...
export const DE_TO_EN: Record<string, string> = {
  ...
  '/best-of-industry-award-2026': '/en/best-of-industry-award-2026',
  ...
  '/magazin/made-in-germany-qualitaet-tempo-laborbau':
    '/en/magazine/made-in-germany-quality-speed-lab-construction',
};
