  ...
  return (
    <div className="pt-20 min-h-screen bg-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Technische Fachplanung", url: "/leistungen/planung" }
      ]} />
      {/* Hero Section */}
      <section className="relative py-24 bg-slate-900 text-white overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/backgrounds/lab-planung.webp')] bg-cover bg-center opacity-20"></div>
