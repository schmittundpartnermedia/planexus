    ...
    <div className="pt-20 min-h-screen bg-white">
      ...
      <section className="py-20 bg-slate-50 border-b border-gray-100">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-slate-900 text-center">Datenschutzerklärung</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto prose prose-lg prose-slate">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Allgemeine Hinweise</h3>
            <p className="text-gray-600 mb-6">
              Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Ausführliche Informationen zum Thema Datenschutz entnehmen Sie unserer unter diesem Text aufgeführten Datenschutzerklärung.
            </p>

            <h3 className="text-xl font-bold text-slate-900 mb-3">Datenerfassung auf dieser Website</h3>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Ihre Rechte</h2>
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Server-Log-Dateien</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-4">5. SSL- bzw. TLS-Verschlüsselung</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-4">7. Aktualität und Änderung dieser Datenschutzerklärung</h2>
            <p className="text-gray-600 mb-6">
